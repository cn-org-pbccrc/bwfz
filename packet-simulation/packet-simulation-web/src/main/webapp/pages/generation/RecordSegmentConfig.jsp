	...
	<input type="hidden" id="versionID" name="version" /> 
		<div class="form-group row">
			<div class="col-lg-6 form-group">
				...
				<div class="col-lg-9">
					<input name="segName" 
						class="form-control" type="text" dataType="Require" id="segNameID" />
			...
			<div class="col-lg-6 form-group">
				...
				<div class="col-lg-9">
					<input name="segMark" 
						class="form-control" type="text" dataType="Require" id="segMarkID" />
					<span class="required">*</span>
				</div>
			</div>
			<div class="col-lg-6 form-group">
				...
				<div class="col-lg-9">
					<input name="segDescID" 
						class="form-control" type="text" id="segDescID" />
				</div>
			</div>
			<div class="col-lg-6 form-group">
		...
		<div class="panel panel-default table-responsive">
				<div class="panel-heading">数据项<button data-role="addRow"  class="btn btn-primary" style="padding:2px 4px;float:right;" type="button"><span class="glyphicon glyphicon-plus"></span></button></div>
