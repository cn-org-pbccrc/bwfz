...
public class RecordSegmentController {
	...
	public InvokeResult get(@PathVariable Long id) {
		...
		@ResponseBody
	@RequestMapping("/findRecordTypeByRecordSegment/{id}")
	public Map<String, Object> findRecordTypeByRecordSegment(@PathVariable Long id) {
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("data", recordSegmentFacade.findRecordTypeByRecordSegment(id));
		return result;
	}
